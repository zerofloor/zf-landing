...
const Post = ({
  ...
  return (
    <>
      <Head>
        <title>{postProperties.Name.title[0].plain_text} - zerofloor.xyz</title>
      </Head>
      <div className="mt-6 sm:ml-12 sm:mt-12 flex flex-col gap-y-1 w-10/12  sm:w-3/5 md:w-1/2">
        ...
        <p className="text-gray-200 text-xs sm:text-md">
          ...
          <span className="ml-6">by <span className="
            bg-clip-text
            text-transparent
            bg-gradient-to-r 
            from-purple-400
            to-pink-600">{postProperties.Author?.rich_text[0]?.plain_text}</span></span>
